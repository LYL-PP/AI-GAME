...
async function main() {
  ...
  await sleep(14000);
  await shot('castle_final7_side45.png');
  await send('Page.navigate', { url: 'http://localhost:8000/?chapter=0&play=1&fresh=1&pos=0,48&yaw=0' });
  await sleep(8000);
  await shot('castle_final7_dock.png');
